			...
			<section className='bg-primary text-primary-foreground'>
				...
				<div className='container px-4 mx-auto max-w-4xl py-16 md:py-20'>
					...
					<p className='text-primary-foreground/80 text-base md:text-lg max-w-2xl'>
						All prices are per square metre (sqm). Prices are
						subject to change with market conditions — contact us
						via WhatsApp for the latest confirmed rates before
						ordering.
					</p>
				</div>
			</section>
			...
			<section className='bg-secondary py-10'>
				<div className='container px-4 mx-auto max-w-4xl'>
					...
					<ul className='text-sm text-muted-foreground space-y-1.5 list-disc pl-5 mb-6'>
						...
						<li>
							Metcopo design attracts an additional ₦250 per sqm.
						</li>
						<li>
							Prices are subject to change with market conditions.
							Always confirm the current price via WhatsApp before
							finalising your order.
						</li>
						<li>
							Delivery charges are calculated separately based on
